...
ray job submit --address="http://127.0.0.1:8265" \
   ...
   --colocate_actor_ref \
   --pretrain /home/jovyan/share/LLMAgent/model/Llama-3.1-8B-Instruct \
   ...
   --vocab_size 32000 \
   --use_prm \
   --save_path /pubshare/fwk/orlhf_checkpoints/checkpoint/llama3-8b-porm_grpo \
   ...
   --wandb_run_name llama3-8b-porm_grpo \
   --wandb_relogin True
