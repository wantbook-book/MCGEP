...
try:
    from mcts.models.vLLM_API import generate_with_vLLM_model
except:
    pass

try:
    from mcts.models.OpenAI_API import generate_n_with_OpenAI_model
except:
    pass
...
class IO_System:
    ...
    def __init__(self, args, tokenizer, model, vllm_generator) -> None:
        self.api = args.api
